...
public class Fossils {
    ...
    Fossils (Sheets sheetsService, String SPREADSHEET_ID) {
        this.setSheetsService(sheetsService);
        this.setSPREADSHEET_ID(SPREADSHEET_ID);
    }

    public void getFossils() {
        GetSpreadsheetData getSpreadsheetData =
                new GetSpreadsheetData(sheetsService, "Fossils", SPREADSHEET_ID);
        ...
        File file = new File("Fossils.csv");
